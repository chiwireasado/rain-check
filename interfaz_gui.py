...
class InterfazRainCheck:
    def __init__(self, root):
        ...
        tk.Button(root, text="Consultar Datos", command=self.buscar_datos, bg="#002060", fg="white",
    ...
    def buscar_datos(self):
        ...
        if token:
            ...
            try:
                peticion = requests.post(url_emt, headers={"accessToken": token},
                                         json={"statistics": "N", "cultureInfo": "ES"})
